...
<div class="wrap">
	...
	<section class="good-guitarist-documentation">
		<h2><?php _e( 'Theme Documentation' ); ?></h2>
		<article>
			<h3><?php _e( 'Blocks' ); ?></h3>
			<div>
				<p><?php _e('
				...
				<p class="inline"><?php _e( 'To learn about the Wordpress built-in blocks,see ' ); ?></p>
				<a class="inline" href="https://gogutenberg.com/blocks/"><?php _e( 'here' ); ?></a>
				<p>
				<?php _e('
			...
			<div>
				<?php _e('
				Youtube Post. Youtube Posts are what you use when you want to pull information from
				a Youtube Video. Youtube posts Call to Action. Call to actions are for any time you
